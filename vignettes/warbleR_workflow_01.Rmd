...
vignette: >
  ...
  %\VignetteIndexEntry{warbleR: 01 - Import sound files and select signals}
...
Check out the `autodetec` documentation for more information. The argument `threshold` is one of the most important detection parameters, as well as information about signal frequency range and duration. _Phaenthornis longirostris_ songs have frequencies between 2 and 10 kHz and durations between 0.05 and 0.5 s. 
